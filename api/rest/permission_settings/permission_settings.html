...
<ul class="introduction-menu">
    <li><a href='#PermissionSettings-Introduction'><strong>Introduction</strong></a></li>
    <li><a href='#PermissionSettings-Authorization'>Authorization</a>
    <ul>
        <li><a href='#PermissionSettings-AccessLevels'>Access Levels</a></li>
        <li><a href='#PermissionSettings-AccessControlList(ACL)'>Access Control List (ACL)</a>
        <ul>
            <li><a href='#PermissionSettings-ACLOverview'>ACL Overview</a></li>
            <li><a href='#PermissionSettings-UnderstandingACL'>Understanding ACL</a></li>
            <li><a href='#PermissionSettings-ACLStructure'>ACL Structure</a></li>
            <li><a href='#PermissionSettings-Read-WritePermissions'>Read/Write Permissions</a></li>
        </ul>
        </li>
        <li><a href='#PermissionSettings-SettingUpACL'>Setting Up ACL</a></li>
    </ul>
    </li>
</ul>
...
<p>The following graphic describes the default rights for each access level with each level obtaining more rights up to Admin who has access to everything.</p>
 ...
 <img src="{{ site.baseurl }}/guides/m1x/images/rest_permissions1.png"/>
...
<img src="{{ site.baseurl }}/guides/m1x/images/rest_permissions2.png" style="border: 1px solid black"/></p>
